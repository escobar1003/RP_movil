...
class _ReservasScreenState extends State<ReservasScreen> {
  ...
  Future<void> _confirmarReserva() async {
    ...
    try {
      final materiales = widget.datosIA != null
          ? [{'material': widget.datosIA!['material'] ?? '', 'peso': widget.datosIA!['pesoAproximado'] ?? '0'}]
          : [];

      await UsuarioService.crearReserva({
        'idPunto': widget.aliado['id'] ?? widget.aliado['nombre'],
          ...
          children: [
            ...
            SizedBox(
              ...
              child: ElevatedButton.icon(
                ...
                label: Text(loading ? 'Procesando...' : 'Revisar reserva'),
