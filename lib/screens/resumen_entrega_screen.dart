...
class ResumenEntregaScreen extends StatefulWidget {
  ...
  @override
  State<ResumenEntregaScreen> createState() => _ResumenEntregaScreenState();
}

class _ResumenEntregaScreenState extends State<ResumenEntregaScreen> {
  bool _cargando = false;

  List<Map<String, dynamic>> get _listaMateriales =>
      widget.materialesIA ?? (widget.datosIA != null ? [widget.datosIA!] : []);
              ...
              children: [
                ...
                if (widget.observaciones.isNotEmpty)
                  _buildSection(
                    ...
                    title: 'Observaciones',
                    child: Text(widget.observaciones,
                        style: const TextStyle(
                          fontSize: 14,
                          color: Color(0xFF1E3A0F),
                          height: 1.4,
                ...
                if (widget.observaciones.isNotEmpty) const SizedBox(height: 24),
                ...
                SizedBox(
                  ...
                  child: ElevatedButton.icon(
                    onPressed: _cargando ? null : _handleConfirmar,
                    icon: _cargando
                        ? const SizedBox(
                            width: 20, height: 20,
                            child: CircularProgressIndicator(color: Colors.white, strokeWidth: 2))
                        : const Icon(Icons.check_circle_outline),
                    label: Text(_cargando ? 'Agendando...' : 'Confirmar entrega'),
                ...
                SizedBox(
                  ...
                  child: TextButton(
                    ...
                    child: Text(
                      ...
                      style: TextStyle(
                        fontSize: 15,
                        color: _cargando ? Colors.grey[300] : Colors.grey[500],
